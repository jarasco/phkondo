                    ...
                    <tbody>
                        <?php foreach ($condos as $condo): ?>
                            ...
                            <tr>
                                ...
                                <td class="hidden-xs"><?php if (isset($condo['FiscalYear'][0]['title'])) echo h($condo['FiscalYear'][0]['title'] . ' ( ' . h($condo['FiscalYear'][0]['open_date']) . ' ' . __('through') . ' ' . h($condo['FiscalYear'][0]['close_date']) . ' ) '); ?>&nbsp;</td>
